...
Now I'll talk about the first few days of [my pencil puzzles class](https://hanusa.xyz/courses/555/16/).  ([Previous post setting the stage](../2016-02-22-teaching-pencil-puzzles/index.qmd).)  I started the first day of class by qualifying that this class was new to me and would be an adventure for them and for me.  I explained that there wouldn't be any lectures, there wouldn't be any exams, and that it was unclear exactly what the assessments would be---the initial ideas I included on the syllabus were:
